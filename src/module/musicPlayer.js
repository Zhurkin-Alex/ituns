...
export const musicPlayerInit = () => {
  ...
  const playlist = ["hello", "flow", "speed", "frozen"]; //название треков в папке аудио

  let trackIndex = 0; // Индекс песни из массива
  ...
  audioNavigation.addEventListener("click", (event) => {
    ...
    if (target.classList.contains("audio-button__play")) {
      audio.classList.toggle("play"); //добавление или удаление класса
  ...
  //Перемотка трека( координаты только через евент(e))
  ...
  //Выключение музыки при переходе на другую страницу
